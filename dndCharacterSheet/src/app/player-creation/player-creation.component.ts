...
export class PlayerCreationComponent implements OnInit {
  ...
  makeChar(){
    ...
    char.levelUp([new features.initalHitDice(), new features.initalHP(), new features.sneakAttack(1), new features.initalProficiencies(this.proficiencies), new features.gainExpertise(1,[this.proficiencies[0],this.proficiencies[1]]), new features.initalProficiencies(['Dexterity','Intelligence'])]);
